 ...
 *  To generate javadoc
 *  -------------------
 *  javadoc -notree -noindex -nohelp -nonavbar StdDraw.java
 *
 *************************************************************************/
...
public final class StdDraw implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
    ...
    *************************************************************************/
    ...
    public static void line(double x0, double y0, double x1, double y1, float thickness) {
    ...
    /**
     * Draw a filled square of width 2r, centered on (x, y); degenerate to pixel if small
     * @param x the x-coordinate of the center of the square
     * @param y the y-coordinate of the center of the square
     * @param r radius is half the size of width
     * @param h is half the size of height
     * @throws RuntimeException if r or h is negative
     *
     */
    public static void filledRectangle(double x, double y, double r, double h) {
        if (r < 0 || h < 0) throw new RuntimeException("rectangle side length can't be negative");
        double xs = scaleX(x);
        double ys = scaleY(y);
        double ws = factorX(2*r);
